...
class CyberShieldApp {
    ...
    content.innerHTML = `
      ...
      <section class="section" id="frameworks-section">
        <div class="container">
          <div class="section-header">
            <span class="section-tag">🛡️ Assessment Frameworks</span>
            <h2>Choose Your <span class="gradient-text">Assessment</span></h2>
            <p>Select from 8 industry-standard cybersecurity frameworks. Each assessment is tailored with extensive questionnaires and generates detailed readiness reports.</p>
          </div>
          <div class="framework-grid">
            ${FRAMEWORK_ORDER.map((id, idx) => {
      ...
      <footer class="footer">
        <div class="container">
          ...
          <p style="margin-top:8px;font-size:0.8rem">All assessments run locally in your browser. No data is transmitted to any server.</p>
        </div>
      </footer>`;
  ...
  showReport(frameworkId) {
    ...
    this.reportGen = new ReportGenerator(frameworkId, scores);
    const content = document.getElementById('app-content');
  ...
  showAssessments() {
    ...
    content.innerHTML = `
      <section class="section">
        <div class="container">
          <div class="section-header">
            <span class="section-tag">🧭 Assessments</span>
            <h2>Quick Access to <span class="gradient-text">Assessments</span></h2>
            <p>Start or continue assessments directly from this central hub.</p>
          </div>
