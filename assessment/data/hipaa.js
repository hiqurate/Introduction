      ...
      categories: [
        {
          ...
          questions: [
            { id: 'HIPAA-A1', text: 'Risk analysis is conducted regularly', context: 'Do you conduct an accurate and thorough assessment of potential risks and vulnerabilities to ePHI?', options: [{label: 'Not Compliant', value: 1, detail: 'No risk analysis performed'}, {label: 'Partially Compliant', value: 2, detail: 'Informal or incomplete risk analysis'}, {label: 'Substantially Compliant', value: 3, detail: 'Regular risk analysis with minor gaps'}, {label: 'Fully Compliant', value: 4, detail: 'Comprehensive, documented risk analysis performed annually'}] },
            { id: 'HIPAA-A2', text: 'Risk management program is implemented', context: 'Have you implemented security measures sufficient to reduce risks and vulnerabilities to a reasonable level?', options: [{label: 'Not Compliant', value: 1, detail: 'No risk management'}, {label: 'Partially Compliant', value: 2, detail: 'Some measures in place'}, {label: 'Substantially Compliant', value: 3, detail: 'Most risks addressed'}, {label: 'Fully Compliant', value: 4, detail: 'Comprehensive risk management with ongoing monitoring'}] },
            { id: 'HIPAA-A3', text: 'Sanction policy exists for workforce members who fail to comply', context: 'Is there a formal sanction policy for employees who violate security policies?', options: [{label: 'Not Compliant', value: 1, detail: 'No sanction policy'}, {label: 'Partially Compliant', value: 2, detail: 'Informal consequences'}, {label: 'Substantially Compliant', value: 3, detail: 'Policy exists but inconsistently applied'}, {label: 'Fully Compliant', value: 4, detail: 'Documented policy consistently enforced'}] },
            { id: 'HIPAA-A4', text: 'Information system activity review is conducted', context: 'Do you regularly review records of information system activity (audit logs, access reports)?', options: [{label: 'Not Compliant', value: 1, detail: 'No activity review'}, {label: 'Partially Compliant', value: 2, detail: 'Occasional log review'}, {label: 'Substantially Compliant', value: 3, detail: 'Regular reviews with some gaps'}, {label: 'Fully Compliant', value: 4, detail: 'Automated monitoring with regular review'}] }
          ]
        },
        {
          ...
          questions: [
            { id: 'HIPAA-A5', text: 'A security officer is designated', context: 'Has a specific individual been designated as the HIPAA Security Officer?', options: [{label: 'Not Compliant', value: 1, detail: 'No security officer'}, {label: 'Partially Compliant', value: 2, detail: 'Informal designation'}, {label: 'Substantially Compliant', value: 3, detail: 'Officer designated but limited authority'}, {label: 'Fully Compliant', value: 4, detail: 'Formally designated with documented responsibilities'}] }
          ]
        },
        {
